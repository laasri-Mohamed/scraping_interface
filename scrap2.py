...
url="https://agroalimentaire.e-pro.fr/val-de-marne/boulangerie-et-boulangerie-patisserie_a_Fontenay-sous-bois,94033,158C"
...
imdb_df=pd.DataFrame({'NomEntreprise':nomEntreprise,'Ville':ville,'Adresse':adresses,'Num Telephne':telephone})
print(imdb_df)
#imdb_df.to_excel('./data/InfoEnterorise1.xlsx',index=False)
